...
def execute (block, config) :
    ...
    cov = block["scale_cuts_output", "inv_covariance"]
    diff = data - theory
    diff_frac = diff/data
    ...
    # np.savetxt("pm_lin_kids1.0.txt",pm_lin)
    # print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ",pm_lin.shape)
    ...
    # np.savetxt("c_ell(me015).txt",c_ell)
