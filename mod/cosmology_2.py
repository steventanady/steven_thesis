...
class Cosmology:
    ...
    def growth_index (self):
        e_equal = self.expansion_function (self.amin)
        v = [ \
             3.0+2.0*self.amin* \
             self.d_expansion_function_d_a (self.amin)/e_equal, \
             1.0-self.omega_m/(self.amin*(e_equal*self.amin)**2) \
            ]
